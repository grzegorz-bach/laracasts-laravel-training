                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img src="/storage/{{ $post->featured_image }}" alt="post featured image"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @else
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Unpublished</span>
                                            @endif
                                        </td>
